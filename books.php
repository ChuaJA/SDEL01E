        ...
        <h1 style="text-align:center; margin-top:10px; font-size:70px; fontfamily:Algerian; color:black">JAC's Market</h1>
            <div style="float:left">
                <div>                    
                    ...
                    <input type="checkbox" id="checkbox3" name="checkbox3" style="margin-left:80px;">
                    ...
                    <input type="checkbox" id="checkbox5" name="checkbox5" style="margin-left:85px;">
                    ...
                    <input type="checkbox" id="checkbox12" name="checkbox12" style="margin-left:75px;">
