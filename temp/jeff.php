...
<div>
 ...
 <input type="text" class="formcontrol input_box1" id="emp_status" name="emp_status" value="<?php echo $emp_status;?>" disabl
ed>
 </div>
 </div>
 </div>
...
<div>
 ...
 <input type="text" class="formcontrol input_box" id="basic_num_hours_cutoff" name="basic_num_hours_cutoff" value="<?php echo
$basic_num_hours_cutoff;?>">
 </div>
<div>
...
<div>
 <span>No. of Hours / Cut Off:</span>
 <input type="text" class="formcontrol input_box" id="other_num_hours_cutoff" name="other_num_hours_cutoff" value="<?php echo
$other_num_hours_cutoff;?>">
 </div>
<div>
 <span>Income / Cut Off:</span>
