...
<form id="pic-upload" class="a-form" enctype="multipart/form-data"
method="post" width='840'>
<h1 style="text-align:center; margin-bottom:30px; font-size:47px; 
font-family:Algerian; color:black"><b>Employee Personal 
Information</b></h1>
<div class="a-form-group mt-3" style="float:left; clear:block; 
width:20%;" >
...
<form id="form_employee_registration_save" class="a-form" action=""
method="post" width='840'>
...
<select class="form-control mt-0" name="nationality"
id="nationality">
<option value="">-- select one --</option>
...
<option
value="Herzegovinian">Herzegovinian</option>
...
<option value="Trinidadian or 
Tobagonian">Trinidadian or Tobagonian</option>
...
<input type="text" class="form-control mt-0"
name="department" id="department" value="">
</div>
<div class="form-group col-3">
...
name="qualified_dependent_status" id="qualified_dependent_status">
<option value=''>-- select one --</option>
...
<input type="text" class="form-control mt-0"
name="contact_number" id="contact_number" value="">
</div>
<div class="form-group col">
...
<input type="text" class="form-control mt-0"
name="social_media_account_id" id="social_media_account_id">
</div>
</div>
</div>
</div>
...
<select class="form-control mt-0" name="country"
id="country">
<option value=''>-- select one --</option>
...
<input type="text" class="form-control mt-0"
name="picpath" id="picpath" value="">
</div>
</div>
</div>
</div>
<button type="submit" class="btn btn-primary" id = "savebtn"
name="savebtn" style="width:130px;">Save</button>
