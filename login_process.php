...
<body>
    <div class="container">
        <img src="images/register.jpg" alt="Logo" class="logo-img">
        <h1>Login Form</h1>
    ...
    <script>
        ...
        form.addEventListener('submit', function (e) {
            ...
            if (username === 'admin' && password === 'admin') {
                // Display a success message and link
                const message = document.getElementById('login-message');
                message.textContent = 'Login successful! You can now ';
                const link = document.createElement('a');
                link.href = 'http://localhost/lpu_web_application/admin_page.php#'; // Add your link URL here
