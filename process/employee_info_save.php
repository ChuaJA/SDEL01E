<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        //getting the data from inputs
            ...
            $qualified_dependent_status = $_POST['qualified_depedent_status'];
            ...
            if ($conn->query(sql1) == TRUE){
                ...
                //echo '<script>window.location.href="http://localhost/lpu_web_application/employee_registration_save.php"</script>';
            } else{
