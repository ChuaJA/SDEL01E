    ...
    <div class="container">   
        <h1 style="text-align:center; margin-top:10px; font-size:70px; fontfamily:Algerian; color:black">JAC's Market</h1>
            <div style="float:left">
                    <div>                    
                    <img src="SDEL01E/Shoes/e1.jpg" data-toggle="tooltip" dataplacement="bottom" title="e1" alt="e1" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">
                    
                    <img src="SDEL01E/Shoes/e2.jpg" data-toggle="tooltip" dataplacement="bottom" title="e2" alt="e2" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">
                    
                    <img src="SDEL01E/Shoes/e3.png" data-toggle="tooltip" dataplacement="bottom" title="e3" alt="e3" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e4.jpg" data-toggle="tooltip" dataplacement="bottom" title="e4" alt="e4" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e5.jpg" data-toggle="tooltip" dataplacement="bottom" title="e5" alt="e5" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">
                    </div>

                    <div>
                    <!--Checkbox and name ROW 1-->
                    <input type="checkbox" id="checkbox1" name="checkbox1" style="margin-left:40px;">
                    <label for="checkbox1" id="lbl_checkbox1" value="">E1 (P600)</label>
                    <input type="checkbox" id="checkbox2" name="checkbox2" style="margin-left:80px;">
                    <label for="checkbox2" id="lbl_checkbox2" value="">E2 (P600)</label>
                    <input type="checkbox" id="checkbox3" name="checkbox3" style="margin-left:90px;">
                    <label for="checkbox3" id="lbl_checkbox3" value="">E3 (P600)</label>
                    <input type="checkbox" id="checkbox4" name="checkbox4" style="margin-left:70px;">
                    <label for="checkbox3" id="lbl_checkbox4" value="">E4 (P600)</label>
                    <input type="checkbox" id="checkbox5" name="checkbox5" style="margin-left:80px;">
                    <label for="checkbox3" id="lbl_checkbox5" value="">E5 (P600)</label>
                    </div>
                    
                    <div>
                    <img src="SDEL01E/Shoes/e6.jpg" data-toggle="tooltip" dataplacement="bottom" title="e6" alt="e6" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e7.jpg" data-toggle="tooltip" dataplacement="bottom" title="e7" alt="e7" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e8.jpg" data-toggle="tooltip" dataplacement="bottom" title="e8" alt="e8" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e9.jpg" data-toggle="tooltip" dataplacement="bottom" title="e9" alt="e9" width="170" height="180" style="margin-top:30px;border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e10.jpg" data-toggle="tooltip" dataplacement="bottom" title="e10" alt="e10" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">
                    </div>

                    <div>
                    <!--Checkbox and name ROW 1-->
                    <input type="checkbox" id="checkbox6" name="checkbox6" style="margin-left:30px;">
                    <label for="checkbox1" id="lbl_checkbox6" value="">E6 (P1200)</label>
                    <input type="checkbox" id="checkbox7" name="checkbox7" style="margin-left:80px;">
                    <label for="checkbox2" id="lbl_checkbox7" value="">E7 (P1200)</label>
                    <input type="checkbox" id="checkbox8" name="checkbox8" style="margin-left:70px;">
                    <label for="checkbox3" id="lbl_checkbox8" value="">E8 (P1200)</label>
                    <input type="checkbox" id="checkbox9" name="checkbox9" style="margin-left:70px;">
                    <label for="checkbox3" id="lbl_checkbox9" value="">E9 (P1200)</label>
                    <input type="checkbox" id="checkbox10" name="checkbox10" style="margin-left:70px;">
                    <label for="checkbox3" id="lbl_checkbox10" value="">E10 (P1200)</label>
                    </div>

                    <div>
                    <img src="SDEL01E/Shoes/e11.png" data-toggle="tooltip" dataplacement="bottom" title="e11" alt="e11" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e12.jpg" data-toggle="tooltip" dataplacement="bottom" title="e12" alt="e12" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e13.jpg" data-toggle="tooltip" dataplacement="bottom" title="e13" alt="e13" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e14.jpg" data-toggle="tooltip" dataplacement="bottom" title="e14" alt="e14" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e15.jpg" data-toggle="tooltip" dataplacement="bottom" title="e15" alt="e15" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">
                    </div>

                    <div>
                    <!--Checkbox and name ROW 1-->
                    <input type="checkbox" id="checkbox11" name="checkbox11" style="margin-left:30px;">
                    <label for="checkbox1" id="lbl_checkbox11" value="">E11 (P1800)</label>
                    <input type="checkbox" id="checkbox12" name="checkbox12" style="margin-left:70px;">
                    <label for="checkbox2" id="lbl_checkbox12" value="">E12 (P1800)</label>
                    <input type="checkbox" id="checkbox13" name="checkbox13" style="margin-left:60px;">
                    <label for="checkbox3" id="lbl_checkbox13" value="">E13 (P1800)</label>
                    <input type="checkbox" id="checkbox14" name="checkbox14" style="margin-left:70px;">
                    <label for="checkbox3" id="lbl_checkbox14" value="">E14 (P1800)</label>
                    <input type="checkbox" id="checkbox15" name="checkbox15" style="margin-left:60px;">
                    <label for="checkbox3" id="lbl_checkbox15" value="">E15 (P1800)</label>
                    </div>
                    
                    <div>
                    <img src="SDEL01E/Shoes/e16.jpg" data-toggle="tooltip" dataplacement="bottom" title="e16" alt="e16" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e17.jpg" data-toggle="tooltip" dataplacement="bottom" title="e17" alt="e17" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e18.jpg" data-toggle="tooltip" dataplacement="bottom" title="e18" alt="e18" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e19.jpg" data-toggle="tooltip" dataplacement="bottom" title="e19" alt="e19" width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">

                    <img src="SDEL01E/Shoes/e20.jpg" data-toggle="tooltip" dataplacement="bottom" title="e20"  alt="e20"width="170" height="180" style="margin-top:30px; border:10px solid white; overflow:hidden; box-shadow: 0 0 5px; margin-bottom:30px ">
                    </div>

                    <div>
                    <!--Checkbox and name ROW 1-->
                    <input type="checkbox" id="checkbox16" name="checkbox16" style="margin-left:30px;">
                    <label for="checkbox1" id="lbl_checkbox16" value="">E16 (P2400)</label>
                    <input type="checkbox" id="checkbox17" name="checkbox17" style="margin-left:70px;">
                    <label for="checkbox2" id="lbl_checkbox17" value="">E17 (P2400)</label>
                    <input type="checkbox" id="checkbox18" name="checkbox18" style="margin-left:70px;">
                    <label for="checkbox3" id="lbl_checkbox18" value="">E18 (P2400)</label>
                    <input type="checkbox" id="checkbox19" name="checkbox19" style="margin-left:60px;">
                    <label for="checkbox3" id="lbl_checkbox19" value="">E19 (P2400)</label>
                    <input type="checkbox" id="checkbox20" name="checkbox20" style="margin-left:60px;">
                    <label for="checkbox3" id="lbl_checkbox20" value="">E20 (P2400)</label>
                    </div>
            </div>           
    </div>
